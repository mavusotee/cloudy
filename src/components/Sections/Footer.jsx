...
function Footer() {
  ...
  useGSAP(() => {
    ...
    if (metaRef.current) {
      const metaItems =
        metaRef.current.querySelectorAll("[data-footer-meta]");
  ...
  return (
    ...
    >
      ...
      <div
        ref={footerInfoRef}
        className="flex flex-col lg:flex-row justify-between w-full gap-[clamp(3rem,4vw,3rem)] md:pt-20"
      >
        {/* =====================================================
            1. LEFT BLOCK
            ===================================================== */}
        ...
        <div className="flex flex-col items-start justify-start space-y-[clamp(1.5rem,3vw,2rem)]">
          <div className="flex flex-col space-y-[clamp(1.2rem,2vw,1.3rem)]">
            <SmudgyTextReveal
              className="w-full max-w-[clamp(35rem,40vw,30.9125rem)] tracking-tight text-[clamp(1.5rem,2.4vw,3rem)] font-sans font-medium text-ghost-white leading-[100%] uppercase"
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M41.0538 0.38585V32.8691C41.0538 33.0816 40.8588 33.254 40.6186 33.254H27.6422C27.402 33.254 27.207 33.0816 27.207 32.8691V0.38585C27.207 0.1734 27.402 0.000976562 27.6422 0.000976562H40.6186C40.8588 0.000976562 41.0538 0.1734 41.0538 0.38585Z" fill="white"/>
<path d="M207.792 0C207.792 4.36693 208.222 8.6907 209.058 12.725C209.893 16.7605 211.117 20.4252 212.661 23.5134C214.206 26.6015 216.038 29.0509 218.056 30.7215C220.073 32.3932 222.235 33.2533 224.418 33.2533C226.601 33.2533 228.764 32.3932 230.781 30.7215C232.798 29.0509 234.631 26.6015 236.174 23.5134C237.718 20.4252 238.943 16.7605 239.779 12.725C240.614 8.6907 241.045 4.36693 241.045 0H207.792Z" fill="white"/>
<path d="M208.209 33.2539C208.209 28.887 207.78 24.5632 206.944 20.5289C206.108 16.4935 204.884 12.8287 203.34 9.74053C201.796 6.65239 199.963 4.20296 197.946 2.53238C195.929 0.860737 193.767 0.000572205 191.583 0.000572205C189.4 0.000572205 187.238 0.860737 185.221 2.53238C183.204 4.20296 181.371 6.65239 179.827 9.74053C178.283 12.8287 177.058 16.4935 176.222 20.5289C175.387 24.5632 174.957 28.887 174.957 33.2539L208.209 33.2539Z" fill="white"/>
<path d="M270.173 4.46436C268.492 3.14797 266.557 2.07789 264.477 1.31524C262.397 0.552595 260.213 0.112224 258.05 0.0195031C255.886 -0.073309 253.785 0.183251 251.869 0.77448C249.951 1.36571 248.254 2.27999 246.874 3.46521C245.495 4.65044 244.46 6.08328 243.828 7.6821C243.197 9.28083 242.982 11.0144 243.194 12.7833C243.407 14.5519 244.043 16.3215 245.068 17.9916C246.091 19.6618 247.484 21.199 249.164 22.5147L259.668 13.4893L270.173 4.46436Z" fill="white"/>
<path d="M241.235 28.8183C242.918 30.1304 244.856 31.1958 246.939 31.9543C249.021 32.7123 251.206 33.1483 253.371 33.2369C255.536 33.3254 257.637 33.0643 259.554 32.4698C261.471 31.8757 263.168 30.9588 264.546 29.7711C265.925 28.5844 266.957 27.1501 267.587 25.5514C268.216 23.9523 268.429 22.2197 268.214 20.4525C267.999 18.6849 267.358 16.9177 266.331 15.2509C265.304 13.5844 263.909 12.051 262.226 10.7383L251.73 19.7785L241.235 28.8183Z" fill="white"/>
<path fill-rule="evenodd" clip-rule="evenodd" d="M152.752 0.384868V32.8683C152.752 33.0805 152.542 33.2532 152.284 33.2532H139.372C139.113 33.2532 138.904 33.0805 138.904 32.8683V0.384868C138.904 0.172428 139.113 0 139.372 0H152.284C152.542 0 152.752 0.172428 152.752 0.384868Z" fill="white"/>
<path fill-rule="evenodd" clip-rule="evenodd" d="M172.142 0.384868V32.8683C172.142 33.0805 171.932 33.2532 171.674 33.2532H158.763C158.505 33.2532 158.295 33.0805 158.295 32.8683V0.384868C158.295 0.172428 158.505 0 158.763 0H171.674C171.932 0 172.142 0.172428 172.142 0.384868Z" fill="white"/>
<path d="M172.142 7.92871H138.889V31.791H172.142V7.92871Z" fill="white"/>
          </svg>
        </div>
