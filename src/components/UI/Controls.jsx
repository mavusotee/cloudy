...
function Controls({
  ...
  return (
    <div
      ref={containerRef}
      className="flex items-center justify-between text-ghost-white w-full select-none"
    >
      {/* LEFT-CONTROLS */}
      {/* LEFT-CONTROLS: STUDIO LOCATION */}
      <div className="hidden md:flex flex-col items-start justify-start space-y-1 w-[clamp(140px,30vw,360px)]">
        ...
        <div className="flex items-center justify-between w-full text-[clamp(0.65rem,0.5rem+0.55vw,1.85rem)] font-geist-mono">
          <div className="overflow-hidden pb-0.5">
            <h1 className="mask-text truncate block origin-left">
              ADL [34.92° S]
            </h1>
          </div>
          <div className="overflow-hidden pb-0.5">
            <h2 className="mask-text shrink-0 ml-2 font-geist-mono font-medium block origin-left">
              {duration}
            </h2>
          </div>
        </div>
