...
function page() {
  return (
    <div className="w-full min-h-dvh bg-carbon-black p-4 md:p-8">
      ...
      {/*Top Content: Switch to CSS Grid for bulletproof two-column layout on desktop, stack on mobile */}
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 w-full pt-20 items-start">
        ...
        <div className="flex flex-col space-y-18 lg:col-span-7 w-full">
          ...
          <div className="flex flex-col gap-y-6">
            ...
            {/* Clamped headline size scaling smoothly from mobile to desktop */}
        ...
        <div className="flex flex-col gap-3 lg:col-span-5 w-full items-start lg:items-start">
           <div className="w-full max-w-[220px] lg:max-w-[500px] h-[clamp(18rem,38vw,42rem)] relative">
             <Image 
               src="/Images/JAKE.png" 
               alt="Jake McIntosh" 
               fill 
           ...
           <h1 className="font-geist-mono font-medium text-[clamp(0.6rem,1vw,0.85rem)] text-zinc-400 tracking-tight text-left lg:text-left w-full max-w-[420px] lg:max-w-none">
      ...
      {/* BOTTOM CONTENT */}
      <div className="flex flex-col-reverse md:flex-row items-start md:items-end justify-between font-geist-mono text-ghost-white text-[clamp(0.3rem,2.5vw,0.725rem)] uppercase w-full gap-[clamp(0.55rem,0.8vw,1.5rem)] pt-[clamp(2.5rem,6vw,4rem)] pt-10 md:pt-0">
