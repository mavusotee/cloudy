...
function Home() {
  ...
  // =========================================================
  // SESSION-BASED INTRO STATE
  // =========================================================

  const hasSeenPreloaderRef = useRef(false)

  const hasSeenInteractionGuideRef = useRef(false)
  ...
  useEffect(() => {
    ...
    hasSeenPreloaderRef.current =
      sessionStorage.getItem('cloudhaus-preloader-seen') === 'true'


    hasSeenInteractionGuideRef.current =
      sessionStorage.getItem('cloudhaus-interaction-guide-seen') === 'true'


    if (hasSeenPreloaderRef.current) {
    ...
    if (hasSeenInteractionGuideRef.current) {
  ...
  useEffect(() => {
    ...
    if (hasSeenPreloaderRef.current) return
  ...
  // =========================================================
  // AUTOMATICALLY SHOW INTERACTION GUIDE ONCE PER SESSION
  // =========================================================
  ...
  useEffect(() => {
    ...
    const timer =
      setTimeout(() => {
        ...
        sessionStorage.setItem(
          'cloudhaus-interaction-guide-seen',
          'true'
        )
