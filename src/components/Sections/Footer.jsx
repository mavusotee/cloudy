...
function Footer() {
  ...
  return (
    <div id='footer' className="w-full min-h-[100vh] md:min-h-[120vh] flex flex-col items-start justify-between pt-[clamp(2.5rem,8vw,5.5rem)] px-0 bg-black">
      ...
      <div className="w-full mt-auto flex flex-col justify-end pb-1 md:pb-0">
        {/* CLOUDHAUS SVG LOGO */}
        <div className="w-full select-none pointer-events-none flex items-center justify-center -mb-1 md:mb-4">
          ...
          >
            ...
            <path fillRule="evenodd" clipRule="evenodd" d="M152.752 0.384868V32.8683C152.752 33.0805 152.542 33.2532 152.284 33.2532H139.372C139.113 33.2532 138.904 33.0805 138.904 32.8683V0.384868C138.904 0.172428 139.113 0 139.372 0H152.284C152.542 0 152.752 0.172428 152.752 0.384868Z" fill="white"/>
            <path fillRule="evenodd" clipRule="evenodd" d="M172.142 0.384868V32.8683C172.142 33.0805 171.932 33.2532 171.674 33.2532H158.763C158.505 33.2532 158.295 33.0805 158.295 32.8683V0.384868C158.295 0.172428 158.505 0 158.763 0H171.674C171.932 0 172.142 0.172428 172.142 0.384868Z" fill="white"/>
